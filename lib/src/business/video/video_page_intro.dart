    ...
    return Column(
      children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  intro.showDesc
                      ? Text(videoDesc, style: TextStyle(color: Colors.grey))
                      : SizedBox.shrink(),
                ],
              ),
            ),
        ...
        Row(
          ...
          children: [
            _buildVideoStat("1.1万", "icon_thumb_up".png, () {}),
            _buildVideoStat("1243", "icon_coin".png, () {}),
            _buildVideoStat("4562", "icon_collect".png, () {}),
            _buildVideoStat("缓存", "icon_download".png, () {}),
            _buildVideoStat("204", "icon_share".png, () {}),
          ],
        ),
      ],
    );
