  ...
  static final lightTheme = ThemeData(
    extensions: [
      const AppColor(
        ...
        sideBarButtonBackground: Color(0xFFE8E8E8),
        defaultAvatarBackground: Color(0xFFE0E0E0),
        defaultAvatarIcon: Color(0xFF9E9E9E),
        dividerColor: Color(0xFF9E9E9E),
        inputBackground: Colors.black,
        inputHintText: Color(0xFF9E9E9E),
        messageBubbleLeft: Color(0xFF9E9E9E),
        messageTimeText: Color(0xFF9E9E9E),
        tabBarBadgeBackground: Color(0xFFE0E0E0),
        tabBarBadgeText: Color(0xFF9E9E9E),
        searchSuggestBackground: Colors.white,
        searchSuggestHoverBackground: Color(0xFFE0E0E0),
        secondaryText: Color(0xFF9E9E9E),
        videoPageBackground: Color(0xFF333333),
        videoPageText: Colors.white,
        videoPageSecondaryText: Color(0xFF9E9E9E),
      ),
    ],
  ...
  static final darkTheme = ThemeData(
    extensions: [
      AppColor(
        ...
        sideBarBackground: Color(0xFF424242),
        sideBarButtonBackground: Color(0xFF616161),
        defaultAvatarBackground: Color(0xFF424242),
        defaultAvatarIcon: Color(0xFF9E9E9E),
        dividerColor: Color(0xFF757575),
        inputBackground: Color(0xFF2E2E2E),
        inputHintText: Color(0xFF9E9E9E),
        messageBubbleLeft: Color(0xFF616161),
        messageTimeText: Color(0xFF9E9E9E),
        tabBarBadgeBackground: Color(0xFF616161),
        tabBarBadgeText: Color(0xFFBDBDBD),
        searchSuggestBackground: Color(0xFF2E2E2E),
        searchSuggestHoverBackground: Color(0xFF424242),
